...
return (function() { 
var G__37641__delegate = function (args){
...
while (G__37642__i < G__37642__a.length) {G__37642__a[G__37642__i] = arguments[G__37642__i + 0]; ++G__37642__i;}
  args = new cljs.core.IndexedSeq(G__37642__a,0,null);
} 
return G__37641__delegate.call(this,args);};
G__37641.cljs$lang$maxFixedArity = 0;
G__37641.cljs$lang$applyTo = (function (arglist__37643){
var args = cljs.core.seq(arglist__37643);
return G__37641__delegate(args);
});
...
var or__4126__auto__ = (function (){var G__37544 = c;
var G__37544__$1 = (((G__37544 == null))?null:G__37544.constructor);
...
var G__37547 = c;
var G__37547__$1 = (((G__37547 == null))?null:G__37547.constructor);
if((G__37547__$1 == null)){
return null;
} else {
return G__37547__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__37552 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37553 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37553);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37552);
}});
...
var c = this;
var G__37559_37648 = goog.object.get(c,"cljsRatom");
if((G__37559_37648 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37559_37648);
}
...
var renders_37650 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_37651 = cljs.core.first(cljs.core.vals(renders_37650));
...
if((cljs.core.count(renders_37650) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37650))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37651)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37651], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__37594 = o;
goog.object.set(G__37594,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__37629 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37630 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37630);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37629);
}});
...
var vec__37631 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37631,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37631,(1),null);
...
var G__37634 = goog.object.get(reagent_state,"cljsRatom");
if((G__37634 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__37634);
}
});
}),[]);
