...
var G__37653 = o;
goog.object.set(G__37653,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__37687__i < G__37687__a.length) {G__37687__a[G__37687__i] = arguments[G__37687__i + 0]; ++G__37687__i;}
  args = new cljs.core.IndexedSeq(G__37687__a,0,null);
} 
return G__37684__delegate.call(this,args);};
G__37684.cljs$lang$maxFixedArity = 0;
G__37684.cljs$lang$applyTo = (function (arglist__37688){
var args = cljs.core.seq(arglist__37688);
...
var G__37659 = o;
goog.object.set(G__37659,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37660__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__37661 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__37661,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__37661;
}
})(),id_class);
...
var G__37662 = (cljs.core.count(argv) - first_child);
switch (G__37662) {
case (0):
...
var vec__37663 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37663,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37663,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37663,(2),null);
...
var temp__5739__auto___37707 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37707 == null)){
} else {
var key_37708 = temp__5739__auto___37707;
(jsprops.key = key_37708);
}
...
var temp__5739__auto___37710 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___37710 == null)){
} else {
var key_37715 = temp__5739__auto___37710;
(jsprops.key = key_37715);
}
...
var temp__5739__auto___37721 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___37721 == null)){
} else {
var key_37722 = temp__5739__auto___37721;
(jsprops.key = key_37722);
}
...
var temp__5739__auto___37729 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37729 == null)){
} else {
var key_37730 = temp__5739__auto___37729;
(jsprops.key = key_37730);
}
...
var temp__5739__auto___37734 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___37734 == null)){
} else {
var key_37735 = temp__5739__auto___37734;
(jsprops.key = key_37735);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37666_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__37666_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__37667 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37667,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37667,(1),null);
...
break;
default:
var G__37740 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__37741 = compiler;
v = G__37740;
compiler = G__37741;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template37673 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template37673 = (function (opts,id,fn_to_element,meta37674){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template37673.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_37675,meta37674__$1){
var self__ = this;
var _37675__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template37673(self__.opts,self__.id,self__.fn_to_element,meta37674__$1));
}));

(reagent.impl.template.t_reagent$impl$template37673.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_37675){
var self__ = this;
var _37675__$1 = this;
return self__.meta37674;
}));

(reagent.impl.template.t_reagent$impl$template37673.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template37673.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template37673.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template37673.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template37673.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta37674","meta37674",-1522388878,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template37673.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template37673.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template37673");

(reagent.impl.template.t_reagent$impl$template37673.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template37673");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template37673.
 */
reagent.impl.template.__GT_t_reagent$impl$template37673 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template37673(opts__$1,id__$1,fn_to_element__$1,meta37674){
return (new reagent.impl.template.t_reagent$impl$template37673(opts__$1,id__$1,fn_to_element__$1,meta37674));
});

}

return (new reagent.impl.template.t_reagent$impl$template37673(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
